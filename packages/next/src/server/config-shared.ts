...
export interface ExperimentalConfig {
  ...
  /**
   * A different deployment id to use for static assets (as opposed to the config.deploymentConfig)
   *
   * @default false
   */
  immutableDeploymentId?: string
...
export function getNextConfigRuntime(
  ...
  let experimental = ex
    ? ({
        ...
        immutableDeploymentId: ex.immutableDeploymentId,
